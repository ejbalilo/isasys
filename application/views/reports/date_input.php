...
$(document).ready(function()
{
	...
	{		
		...
		{
			window.location = window.location+'/'+$("#report_date_range_simple option:selected").val() + '/' + sale_type + '/0/' + $("#classification").val();
		}
		else
		{
			...
			window.location = window.location+'/'+start_date + '/'+ end_date+ '/' + sale_type + '/0/' + $("#classification").val();
		}
	});
