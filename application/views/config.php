...
<div class="field_row clearfix">	
<?php echo form_label('Temporary Payments Module:','',array('class'=>'wide')); ?>
	<div class='form_field'>
	<a href='/payments.php' target='_blank'>Click here to access</a>
	</div>
</div>

<div class="field_row clearfix">
<?php echo form_label('Fix Report:','',array('class'=>'wide')); ?>
	<div class='form_field'>
	<a href='/_fix.php' target='_blank'>Click here to fix</a>
	</div>
</div>
...
<div>
	<div class='form_field'>
		<?php echo form_open('config/shutdown',array('id'=>'shutdown_form')); ?><input type="submit" id="shutdown" name="shutdown" value="Click to shutdown server" /><?php echo form_close(); ?>
	</div>
</div>
...
<div>
	<div class='form_field'>
		<?php echo form_open('config/restart',array('id'=>'restart_form')); ?><input type="submit" id="restart" name="restart" value="Click to restart server" /><?php echo form_close(); ?>
	</div>
</div>
<div id="feedback_bar"></div>
<?php } ?>
