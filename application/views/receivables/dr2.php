...
<div id="receipt_wrapper">
	...
	<table cellspacing="0" id="receipt_items" style="font-size:12px;">
		...
		<tr>
			<td colspan="4" align="right"><b>Net <?php echo $this->lang->line('sales_total'); ?></b></td>
			<td align="right"><span style="border-bottom:1px solid #000000;"><?php echo to_currency($total+$total_no_discount); ?></span></td>
		</tr>
		<tr>
			<td colspan="4" align="right"><b>Sales Agent Commission</b></td>
			<td align="right"><?php echo to_currency(($total+$total_no_discount)*$sales_agent_commission/100); ?></td>
		</tr>
		<tr>
			<td colspan="4" align="right"><b><?php echo $this->lang->line('sales_total'); ?></b></td>
			<td align="right"><span style="border-bottom:3px double #000000;"><?php echo to_currency($total+$total_no_discount-(($total+$total_no_discount)*$sales_agent_commission/100)); ?></span></td>
		</tr>
		<?php for(;$count<7;$count++) echo "<tr><td colspan=\"5\">&nbsp;</td></tr>"; ?>
		<?php if($count>7) for(;$count<42;$count++) echo "<tr><td colspan=\"5\">&nbsp;</td></tr>"; ?>
	</table>
	</center>
