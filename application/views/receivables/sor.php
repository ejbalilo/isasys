...
<div id="receipt_wrapper">
	<table width="100%" border="0">
		...
		<tr>
			<td align="center" colspan="5"><h2>SALES ORDER REQUEST</h2></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="5"><table width="100%"><tr>
				<td width="50%"><table>
					<tr><td align="right" width="10%"><b>Request For:</b>&nbsp;</td><td width="40%"><?php echo $customer_name; ?></td></tr>
	...
	<table cellspacing="0" id="receipt_items" style="font-size:14px;">
		...
		<tr>
			...
			?>
			<td style="border:1px #000 solid;" align="center"><?php echo (int)$receivable_item['quantity_transferred'] ?></td>
			...
			<td style="border:1px #000 solid;" align="right"><?php $subtotal = $receivable_item['quantity_transferred']*$receivable_item['item_unit_price'];$total+=$subtotal;echo to_currency($subtotal) ?></td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td valign="top">
				<table border="1" width="100%" id="form_table">
					...
					<tr>
						<td valign="top"><b>Request Order By:</b><br />&nbsp;<br />&nbsp;</td>
					</tr>
				</table>
			</td>
		</tr>
