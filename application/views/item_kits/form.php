...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_unit_price').':', 'unit_price',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'unit_price',
		'id'=>'unit_price',
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_unit_price').' 2:', 'unit_price',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'unit_price2',
		'id'=>'unit_price2',
		'value'=>$item_kit_info->unit_price2)
	);?>
	</div>
</div>

<div class="field_row clearfix">
<?php echo form_label('Is Discountable:', 'is_discountable',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_checkbox(array(
		'name'=>'is_discountable',
		'id'=>'is_discountable',
		'value'=>1,
		'checked'=>($item_kit_info->is_discountable)?1:0)
	);?>
	</div>
</div>
...
<table id="item_kit_items">
	...
	<?php foreach ($this->Item_kit_items->get_info($item_kit_info->item_kit_id) as $item_kit_item) {?>
		<tr>
			...
			<td>[<?php echo $item_info->item_number; ?>]<br /><?php echo $item_info->name; ?></td>
...
$(document).ready(function()
{
	$('#item_kit_form').validate({
		...
		messages:
		{
			...
			unit_price:"SRP is a required field"
		}
	});
});
