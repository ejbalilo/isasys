...
<div id="title_bar">
	...
	<?php if($canedit){ ?>
	<div id="new_button">
		<?php echo anchor("$controller_name/view/0/width:$form_width",
...
<div id="table_action_header">
	<ul>
		<?php if($canedit){ ?><li class="float_left"><span><?php echo anchor("$controller_name/delete",$this->lang->line("common_delete"),array('id'=>'delete')); ?></span></li>
		<li class="float_left"><span><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"),array('id'=>'bulk_edit','title'=>$this->lang->line('items_edit_multiple_items'))); ?></span></li><?php } ?>
