...
class Detailed_sales extends Report
{
	...
	{
		return array('summary' => array("DR#", $this->lang->line('reports_date'), $this->lang->line('reports_items_purchased'), $this->lang->line('reports_sold_to'), $this->lang->line('reports_total'), $this->lang->line('reports_profit'), "Balance", $this->lang->line('reports_comments')),
					'details' => array($this->lang->line('items_item_number'), $this->lang->line('reports_name'), $this->lang->line('reports_category'), $this->lang->line('reports_quantity_purchased'), 'Gross Sales', 'Net Sales', $this->lang->line('reports_profit'),$this->lang->line('reports_discount'))
		);		
	}
	...
	public function getData(array $inputs)
	{
		...
		$query = $this->db->query("
			SELECT
				*,
				...
				SUM(((quantity_transferred-quantity_returned)*item_unit_price*(100-discount_percent)/100)-((quantity_transferred-quantity_returned)*item_cost_price*(100-discount_percent)/100)) AS profit,
		...
		foreach($data['summary'] as $key=>$value)
		{
			...
			$this->db->select('
				...
				(0) AS tax,
				((quantity_transferred-quantity_returned)*item_unit_price*(100-discount_percent)/100)-((quantity_transferred-quantity_returned)*item_cost_price*(100-discount_percent)/100) AS profit,
				discount_percent');
