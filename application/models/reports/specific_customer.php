...
class Specific_customer extends Report
{
	...
	public function getData(array $inputs)
	{
		$query = $this->db->query("
			...
			WHERE status>0 AND DATE(receivable_date) BETWEEN '".$inputs['start_date']."' AND '".$inputs['end_date']."' AND person_id = ".$inputs['customer_id']."
	...
	public function getSummaryData(array $inputs)
	{
		...
		$query = $this->db->query("
			...
			WHERE mode=0 AND DATE(receivable_date) BETWEEN '".$inputs['start_date']."' AND '".$inputs['end_date']."' AND ospos_receivables.person_id = ".$inputs['customer_id']);
